...
function GainLossChart() {
  ...
  return (
    ...
    >
      ...
      <Area seriesId="prices" fill={`url(#${gradientId}-gradient)`} />
      <Line strokeWidth={3} seriesId="prices" stroke={solidColor} />
...
function PointsChart() {
  ...
  return (
    ...
    >
      <Area seriesId="prices" fill={`rgb(${theme.color.blue5})`} />
      <Line
        seriesId="prices"
...
<LineChart
  ...
  transitionConfigs={{ update: { type: 'spring', stiffness: 700, damping: 20 } }}
>
  <Scrubber transitionConfigs={{ update: { type: 'spring', stiffness: 700, damping: 20 } }} />
</LineChart>
```
  ...
  series={[
    {
      ...
      gradient: {
        ...
        stops: [
          ...
          { offset: 14, color: `rgb(${theme.spectrum.pink10})`, opacity: 1 },
        ],
      },
    },
  ]}
