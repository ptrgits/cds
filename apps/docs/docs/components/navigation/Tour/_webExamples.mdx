    ...
    return (
      <VStack gap={2}>
        <HStack gap={2} alignItems="center">
          ...
          <Checkbox checked={hideOverlay} onChange={setHideOverlay}>
            Hide overlay
          </Checkbox>
        </HStack>
        <HStack gap={4}>
...
The custom arrow component **must** forward a ref using `forwardRef`. Without this, the arrow positioning will not work correctly.
...
The Tour component renders as a modal dialog with proper ARIA attributes.
You can provide additional accessibility labels.
...
function AccessibilityExample() {
  ...
  return (
    <Tour
      ...
      steps={tourSteps}
      // Accessibility props
      accessibilityLabel="Product tour walkthrough"
      id="product-tour"
    >
      <TourContent />
    </Tour>
...
For coachmark steps, always provide accessibility labels for close buttons:
...
const AccessibleStep = () => {
  ...
  return (
    <Coachmark
      ...
      closeButtonAccessibilityLabel="Close tour"
...
function PortalExample() {
  return (
    <Tour
      ...
      onChange={setActiveTourStep}
      steps={tourSteps}
      // Disable portal rendering (use with caution)
      disablePortal
    >
      <TourContent />
    </Tour>
