...
export type TableContainerProps = SharedProps &
...
const TableContainerWithRef = forwardRef<HTMLTableElement, TableContainerProps>(
  function TableContainerWithRef(
    {
      children,
      variant = 'default',
      bordered,
...
export const TableContainer = memo(TableContainerWithRef);
