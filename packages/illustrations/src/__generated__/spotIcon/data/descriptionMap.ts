...
const descriptionMap: Record<string, string[]> = {
  ...
  wallet: ['walletLogo', 'productWallet', 'walletAsAServiceProduct', 'wallet'],
  ...
  prime: ['arrowsUpDown', 'primeProduct', 'derivativesProduct'],
  advanced: [
    'arrowsUpDown',
    'businessProduct',
    'advancedTradeProduct',
  ...
  trade: ['businessProduct', 'advancedTradeProduct', 'coinbaseOneChart'],
  coinbaseone: ['businessProduct', 'coinbaseOneChart'],
  One: ['businessProduct', 'coinbaseOneChart', 'coinbaseOneEarn'],
  '': [
    'businessProduct',
    'nodeProduct',
    'rewardsProduct',
